...
urlpatterns = [
    ...
    path('produits/export/excel/', views.exporter_produits_excel, name='exporter_produits_excel'),
 ...
 #   path('parametres/',  views.parametres_application, name='parametres_app'),
   ...
   # path("commandes/<int:pk>/", views.detail_commande, name="detail_commande"),
    ...
    path('appliquer_remise/<int:client_id>/<str:mois_filtre>/', views.appliquer_remise, name='appliquer_remise'),
    path('parametres/',  views.parametres_application, name='parametres_app'),
